    ...
    return (
        <div className="container navbar-styles">
            <nav className="navbar navbar-expand-md my-auto">    
                <Link to="/home" className="navbar-brand branding">
                ...
                <div className="collapse navbar-collapse">
                    <ul className={click ? 'nav-menu-active navbar-nav ml-auto' : 'nav-menu navbar-nav ml-auto'}>
                        <li className={click ? 'nav-item active nav-item-style' : 'nav-item nav-item-style'}>
                            <Link to='/home' className='nav-link nav-link-style' onClick={closeMobileMenu}> Home
                            </Link>
                        </li>
                        <li className={click ? 'nav-item active nav-item-style' : 'nav-item nav-item-style'}>
                            <Link to='/aboutus' className='nav-link nav-link-style' onClick={closeMobileMenu}> About Us
                            </Link>
                        </li>
                        <li className={click ? 'nav-item active nav-item-style' : 'nav-item nav-item-style'}>
                            <Link to='/contactus' className='nav-link nav-link-style' onClick={closeMobileMenu}> Contact Us
                            </Link>
                        </li>
                        <li className={click ? 'nav-item active nav-item-style' : 'nav-item nav-item-style'}>
