        ...
        <div className='row row-intersection'>
          <div className='col-md-4'>
            <Card>
              ...
              <Card.Body>
                ...
                <Card.Subtitle>Leo Tolstoy</Card.Subtitle>
                <Card.Link>
          ...
          <div className='col-md-4'>
            <Card>
              ...
              <Card.Body>
                <Card.Title>Anna Karenina</Card.Title>
                <Card.Subtitle>Leo Tolstoy</Card.Subtitle>
                <Card.Link>
                  <Link to='/bookDisplay'>User: Dhanishtha Ghosh</Link>
                </Card.Link>
          ...
          <div className='col-md-4'>
            <Card>
              ...
              <Card.Body>
                <Card.Title>A Midsummer Night's Dream</Card.Title>
                <Card.Subtitle>William Shakespeare</Card.Subtitle>
                <Card.Link>
                  <Link to='/bookDisplay'>User: Dhanishtha Ghosh</Link>
                </Card.Link>
              </Card.Body>
        ...
        <div className='col-md-4'>
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Subtitle>Mario Puzo</Card.Subtitle>
              <Card.Link>
                <Link to='/bookDisplay'>User: Dhanishtha Ghosh</Link>
              </Card.Link>
            </Card.Body>
